 ...
 */
public abstract class MyCustomViewTarget<T extends View, Z> implements Target<Z> {

    private static final String TAG = "MyCustomViewTarget";
     ...
     */
    public MyCustomViewTarget(@NonNull T view) {
    ...
    @NonNull
    public final MyCustomViewTarget<T, Z> waitForLayout() {
    ...
    public final MyCustomViewTarget<T, Z> clearOnDetach() {
    ...
    @SuppressWarnings({"UnusedReturnValue", "WeakerAccess"})
    @Deprecated
    public final MyCustomViewTarget<T, Z> useTagId(@IdRes int tagId) {
        return this;
    }
